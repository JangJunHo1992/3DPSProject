...
class CWizard_Move_Strafe_Run_Front : public CState<CWizard_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CWizard_GamePlay::Wizard_State::Wizard_Move_Strafe_Run_Front;
};
