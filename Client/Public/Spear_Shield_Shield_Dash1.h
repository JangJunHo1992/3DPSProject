...
class CSpear_Shield_Shield_Dash1 : public CState<CKnightGuard_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CKnightGuard::KnightGuard_State::Spear_Shield_Shield_Dash1;
};
