...
class CTwoHandedHammerSet_Turn_Rotation_Turn_R90 : public CState<CKing_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CKing::King_State::TwoHandedHammerSet_Turn_Rotation_Turn_R90;
};
