...
class CMassive_Greate_Sword_TurnR180 : public CState<CDarkKnight_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CDarkKnight::DarkKnight_State::Massive_Greate_Sword_TurnR180;
};
