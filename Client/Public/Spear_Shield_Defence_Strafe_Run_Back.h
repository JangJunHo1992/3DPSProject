...
class CSpear_Shield_Defence_Strafe_Run_Back : public CState<CKnightGuard_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CKnightGuard::KnightGuard_State::Spear_Shield_Defence_Strafe_Run_Back;
};
