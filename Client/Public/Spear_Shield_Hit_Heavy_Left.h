...
class CSpear_Shield_Hit_Heavy_Left : public CState<CKnightGuard_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CKnightGuard::KnightGuard_State::Spear_Shield_Hit_Heavy_Left;
};
