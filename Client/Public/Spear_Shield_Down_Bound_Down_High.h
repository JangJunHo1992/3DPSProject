...
class CSpear_Shield_Down_Bound_Down_High : public CState<CKnightGuard_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CKnightGuard::KnightGuard_State::Spear_Shield_Down_Bound_Down_High;
};
