...
class CMagical_Knight_Hit_Heavy_Front : public CState<CRaider_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CRaider::Raider_State::Magical_Knight_Hit_Heavy_Front;
};
