...
class CWizard_ATK_Skill_Casting_Start : public CState<CWizard_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CWizard_GamePlay::Wizard_State::Wizard_ATK_Skill_Casting_Start;
};
