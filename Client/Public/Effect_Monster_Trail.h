...
class CEffect_Monster_Trail : public CAlphaObject
{
protected:
	CEffect_Monster_Trail(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEffect_Monster_Trail(const CEffect_Monster_Trail& rhs);
	virtual ~CEffect_Monster_Trail() = default;
...
public:
	static CEffect_Monster_Trail* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
