...
class CGreatDualBlade_Defense_Loop : public CState<CRaider_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CRaider::Raider_State::Great_DualBlade_anim_defense_loop;
};
