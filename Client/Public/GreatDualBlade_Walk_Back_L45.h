...
class CGreatDualBlade_Walk_Back_L45 : public CState<CRaider_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CRaider::Raider_State::Great_DualBlade_anim_walk_backL45;
};
