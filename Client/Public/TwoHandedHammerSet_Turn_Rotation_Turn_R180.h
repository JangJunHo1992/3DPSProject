...
class CTwoHandedHammerSet_Turn_Rotation_Turn_R180 : public CState<CKing_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CKing::King_State::TwoHandedHammerSet_Turn_Rotation_Turn_R180;
};
