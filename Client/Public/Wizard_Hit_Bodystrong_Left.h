...
class CWizard_Hit_Bodystrong_Left : public CState<CWizard_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CWizard_GamePlay::Wizard_State::Wizard_Hit_Bodystrong_Left;
};
