...
class CTwoHandedHammerSet_Hit_Head_Right : public CState<CKing_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CKing::King_State::TwoHandedHammerSet_Hit_Head_Right;
};
