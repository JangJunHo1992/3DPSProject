...
class CGreatDualBlade_Hit_Head_Front : public CState<CRaider_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CRaider::Raider_State::Great_DualBlade_anim_hit_head_front;
};
