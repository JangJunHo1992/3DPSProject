...
class CTwoHandedHammerSet_Attack_1H_Around : public CState<CKing_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CKing::King_State::TwoHandedHammerSet_Attack_1H_Around;
};
