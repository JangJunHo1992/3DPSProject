...
class CMagical_Knight_Down_Liedown_Idle_Up : public CState<CRaider_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CRaider::Raider_State::Magical_Knight_Down_Liedown_Idle_Up;
};
