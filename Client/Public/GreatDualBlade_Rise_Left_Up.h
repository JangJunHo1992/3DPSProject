...
class CGreatDualBlade_Rise_Left_Up : public CState<CRaider_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CRaider::Raider_State::Great_DualBlade_anim_rise_left_up;
};
