...
class CMagical_Knight_Atk_Energy09_Loop : public CState<CRaider_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CRaider::Raider_State::Magical_Knight_Atk_Energy09_Loop;
};
