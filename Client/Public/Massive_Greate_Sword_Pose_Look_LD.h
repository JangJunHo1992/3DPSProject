...
class CMassive_Greate_Sword_Pose_Look_LD : public CState<CDarkKnight_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CDarkKnight::DarkKnight_State::Massive_Greate_Sword_Pose_Look_LD;
};
