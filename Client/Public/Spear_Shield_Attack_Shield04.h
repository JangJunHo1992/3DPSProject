...
class CSpear_Shield_Attack_Shield04 : public CState<CKnightGuard_GamePlay>
{
public:
...
public:
	static const _uint g_iAnimIndex = CKnightGuard::KnightGuard_State::Spear_Shield_Attack_Shield04;
};
