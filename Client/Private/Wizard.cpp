...
HRESULT CWizard::Ready_PartObjects()
{
	CWizard_Body::BODY_DESC		BodyDesc = {};
	if (FAILED(Add_Body(TEXT("Prototype_GameObject_Wizard_Body"), BodyDesc)))
		return E_FAIL;


	//{
	//	CWizard_Weapon::WEAPON_DESC	WeaponDesc = {};
	//	if (FAILED(Add_Weapon(TEXT("Prototype_GameObject_Wizard_Weapon"), "ik_hand_l", WeaponDesc, TEXT("Weapon_L"))))
	//		return E_FAIL;
	//}

	//{
	//	CWizard_Weapon::WEAPON_DESC	WeaponDesc = {};
	//	if (FAILED(Add_Weapon(TEXT("Prototype_GameObject_Wizard_Weapon"), "ik_hand_r", WeaponDesc, TEXT("Weapon_R"))))
	//		return E_FAIL;
	//}
