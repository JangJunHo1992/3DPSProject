...
//void CGolem::Write_Json(json& Out_Json)
//{
...
HRESULT CGolem::Ready_Components_Origin(LEVEL eLevel)
{
	/* For.Com_Navigation */
...
HRESULT CGolem::Ready_PartObjects()
{
	CGolem_Body::BODY_DESC		BodyDesc = {};
	if (FAILED(Add_Body(TEXT("Prototype_GameObject_Golem_Body"), BodyDesc)))
		return E_FAIL;


	//{
	//	CGolem_Weapon::WEAPON_DESC	WeaponDesc = {};
	//	if (FAILED(Add_Weapon(TEXT("Prototype_GameObject_Golem_Weapon"), "ik_hand_l", WeaponDesc, TEXT("Weapon_L"))))
	//		return E_FAIL;
	//}

	//{
	//	CGolem_Weapon::WEAPON_DESC	WeaponDesc = {};
	//	if (FAILED(Add_Weapon(TEXT("Prototype_GameObject_Golem_Weapon"), "ik_hand_r", WeaponDesc, TEXT("Weapon_R"))))
	//		return E_FAIL;
	//}
