...
CParticle_Parry::PARTICLE_DESC CWeapon_Client::Get_Particle_Parry_Desc()
{
	...
	Desc.ParticleDesc.fAcceleration = -4.f;
	Desc.ParticleDesc.vRotationX = _float2(180.f,270.f);
	Desc.ParticleDesc.vRotationY = _float2(270.f, 360.f);
	Desc.ParticleDesc.vRotationZ = _float2(270.f, 360.f);
	Desc.ParticleDesc.vLifeTime = _float2(0.9f, 2.9f);
	Desc.ParticleDesc.vScaleX = _float2(0.01f, 0.01f);
	Desc.ParticleDesc.vScaleY = _float2(0.01f, 0.01f);
