#include "..\Public\Raider_Weapon.h"

#include "Character.h"
#include "GameInstance.h"

CRaider_Weapon::CRaider_Weapon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CWeapon_Client(pDevice, pContext)
{
}

CRaider_Weapon::CRaider_Weapon(const CRaider_Weapon& rhs)
	: CWeapon_Client(rhs)
{
}


HRESULT CRaider_Weapon::Initialize_Prototype()
{
...
HRESULT CRaider_Weapon::Initialize(void* pArg)
{
...
void CRaider_Weapon::Priority_Tick(_float fTimeDelta)
{
	__super::Priority_Tick(fTimeDelta);
}

void CRaider_Weapon::Tick(_float fTimeDelta)
{
...
void CRaider_Weapon::Late_Tick(_float fTimeDelta)
{
	__super::Late_Tick(fTimeDelta);
}

HRESULT CRaider_Weapon::Render()
{
...
HRESULT CRaider_Weapon::Ready_Components_Origin(LEVEL eLevel)
{
	/* For.Com_Shader */
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(eLevel, TEXT("Prototype_Component_Model_Raider_Weapon"),
...
HRESULT CRaider_Weapon::Bind_ShaderResources()
{
...
_bool CRaider_Weapon::Collision_Chcek()
{
