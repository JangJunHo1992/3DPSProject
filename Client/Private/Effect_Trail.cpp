...
// 		return E_FAIL;
	...
	{
		if (FAILED(__super::Add_Component(LEVEL_BOSS1, TEXT("Prototype_Component_VIBuffer_Trail"),
			TEXT("Com_Trail"), reinterpret_cast<CComponent**>(&m_pVIBuffer), &TrailDesc)))
			return E_FAIL;
	...
	{
		if (FAILED(__super::Add_Component(LEVEL_BOSS2, TEXT("Prototype_Component_VIBuffer_Trail"),
			TEXT("Com_Trail"), reinterpret_cast<CComponent**>(&m_pVIBuffer), &TrailDesc)))
			return E_FAIL;
