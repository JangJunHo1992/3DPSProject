...
void CJobMob2_Attack3::Initialize(CJobMob2_GamePlay* pActor)
{
...
CState<CJobMob2_GamePlay>* CJobMob2_Attack3::Update(CJobMob2_GamePlay* pActor, _float fTimeDelta)
{
...
void CJobMob2_Attack3::Release(CJobMob2_GamePlay* pActor)
{
