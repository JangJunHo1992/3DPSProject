...
public:
	static CModel_GamePlay* Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext, const MODEL_TYPE eType, const string & strModelFilePath, _fmatrix PivotMatrix);
