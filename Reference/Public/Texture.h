...
public:
	HRESULT Bind_ShaderResource(class CShader* pShader, const _char * pConstantName, _uint iTextureIndex = 0);//따로따로 불러내는거
	HRESULT	Bind_ShaderResources(class CShader* pShader, const _char * pConstantName);//한번에 리소스 다 불러버리기
