...
void CPicking::Tick()
{
	...
	_float4x4	mView = CGameInstance::GetInstance()->Get_TransformFloat4x4(CPipeLine::D3DTS_VIEW);
	_float4x4	mProj = CGameInstance::GetInstance()->Get_TransformFloat4x4(CPipeLine::D3DTS_PROJ);
...
_bool CPicking::Intersect(_Out_ _float3& _vOut, const _float3 _vA, const _float3 _vB, const _float3 _vC, _In_opt_ const _float4x4 _mWorld)
{
