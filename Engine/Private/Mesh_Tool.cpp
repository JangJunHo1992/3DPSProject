...
HRESULT CMesh_Tool::Initialize_Prototype(const MODEL_TYPE eModelType, const MESH_DATA* pAIMesh, _fmatrix PivotMatrix, const vector<class CBone*>& Bones)
{
...
HRESULT CMesh_Tool::Ready_Vertices_NonAnim(const MESH_DATA* pAIMesh, DirectX::XMMATRIX PivotMatrix)
{
...
HRESULT CMesh_Tool::Ready_Vertices_Anim(const MESH_DATA* pAIMesh, const std::vector<Engine::CBone*, std::allocator<Engine::CBone*>>& Bones)
{
...
CMesh_Tool* CMesh_Tool::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const MODEL_TYPE eModelType, const MESH_DATA* pAIMesh, _fmatrix PivotMatrix, const vector<class CBone*>& Bones)
{
