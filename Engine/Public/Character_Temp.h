...
class ENGINE_DLL CCharacter_Temp abstract : public CGameObject
{
protected:
	CCharacter_Temp(ID3D11Device * pDevice, ID3D11DeviceContext * pContext);
	CCharacter_Temp(const CCharacter_Temp& rhs);
	virtual ~CCharacter_Temp() = default;
